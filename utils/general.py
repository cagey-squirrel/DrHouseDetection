...
def class_wise_non_max_suppression(prediction):
    ...
    '''
    Za svaku sliku, za svaku celiju imamo po 11 vrednosti: conf, 4 za pravougaonik i 6 klasa
    Za svaku sliku, za svaku klasu treba odrediti celiju sa maximumom 
    '''

    

    confs = prediction[..., 4]
    classes_probs = prediction[..., 5:]
    ...
    prediction[..., 5:] *= maxes_mask  # For each image we only keep 1 preditction per class (the one with most conf)
